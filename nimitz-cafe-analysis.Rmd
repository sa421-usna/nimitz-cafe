...
In particular, we examine the effect of additional baristas on the average delay experienced
by customers after placing their orders.
...
The empirical cumulative distribution function of the interarrival time data and the theoretical cumulative distribution functions of the fitted distributions are shown on the right. 
...
For our simulation study, we chose to model the interarrival times with the distribution with the lowest Bayesian Information Criterion (BIC): the gamma distribution with shape `r interarrival.fit.gamma$estimate[["shape"]]` and rate `r interarrival.fit.gamma$estimate[["rate"]]`.
...
The empirical cumulative distribution function of the cashier time data and the theoretical cumulative distribution functions of the fitted distributions are shown on the right. 
...
The empirical cumulative distribution function of the service time data and the theoretical cumulative distribution functions of the fitted distributions are shown on the right. 
...
Based on the results presented, increasing the number of baristas from 1 to 2 has the most significant impact, reducing the predicted average delay experienced by customers after placing their orders from 40 minutes to less than half a minute, i.e., by a factor of roughly 80 times. Increasing the number of baristas further also decreases the predicted delay, although not as dramatically. The prediction reliability also increases significantly with added baristas. The reliability of these predictions are imply these estimates have a worst case variability of 12% of the predicted mean.
